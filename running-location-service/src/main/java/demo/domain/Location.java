...
public class Location {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "runningId", column = @Column(name = "unit_running_id")),
            @AttributeOverride(name = "bandMake", column = @Column(name = "unit_band_make")),
            @AttributeOverride(name = "customerName", column = @Column(name = "unit_customer_name")),
            @AttributeOverride(name = "unitNumber", column = @Column(name = "unit_unit_number"))
    })
